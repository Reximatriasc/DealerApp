...
class  PointFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(androidx.navigation.R.layout.fragment_point, container, false)
    ...
    private fun authenticateUser(username: String, email: String, password: String): Boolean {
        ...
        return username == "rexima" && email == "reximacahya@gmail.com" && password == "264108"
    }
}
